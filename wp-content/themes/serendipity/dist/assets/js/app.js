...
var _foundation6 = __webpack_require__(29);

var _foundation7 = __webpack_require__(19);

var _foundation8 = __webpack_require__(30);

var _foundation9 = __webpack_require__(31);

var _foundation10 = __webpack_require__(32);

var _foundation11 = __webpack_require__(33);

var _foundation12 = __webpack_require__(34);

var _foundation13 = __webpack_require__(35);

var _foundation14 = __webpack_require__(36);

var _foundation15 = __webpack_require__(37);

var _foundation16 = __webpack_require__(38);

var _foundation17 = __webpack_require__(20);

var _foundation18 = __webpack_require__(39);

var _foundation19 = __webpack_require__(21);

var _foundation20 = __webpack_require__(40);

var _foundation21 = __webpack_require__(41);

var _foundation22 = __webpack_require__(42);
...
(0, _jquery2.default)(function () {
  if ((0, _jquery2.default)('body').hasClass('about-page')) {

    (0, _jquery2.default)('#testimonials .row').slick({
      dots: false,
      infinite: true,
      speed: 500,
      fade: true,
    ...
    (0, _jquery2.default)('.point').matchHeight();
  }
});
...
(0, _jquery2.default)(function () {
  if ((0, _jquery2.default)('body').hasClass('client-page')) {
    (0, _jquery2.default)('.point').matchHeight();
  }
});
...
(0, _jquery2.default)(function () {
  if ((0, _jquery2.default)('body').hasClass('homepage')) {
    ...
    var a = (0, _jquery2.default)('#words').children();
    var index = 0;
    run();


    (0, _jquery2.default)('.image-container').matchHeight();
    (0, _jquery2.default)('.content-container').matchHeight();
  }
});
...
(0, _jquery2.default)(function () {
  if ((0, _jquery2.default)('body').hasClass('services-page')) {
    (0, _jquery2.default)('.point').matchHeight();
  }
});
...
(0, _jquery2.default)(function () {
  if ((0, _jquery2.default)('body').hasClass('project-post')) {
    (0, _jquery2.default)('.slides').slick({
      dots: true,
      infinite: true,
      speed: 500,
      fade: true,
    ...
    (0, _jquery2.default)('.scroller').on("click", function () {
      if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') && location.hostname == this.hostname) {
        ...
        if (target.length) {
          ...
          if ((0, _jquery2.default)(this).closest('#scroll-down').length == 1) {
            (0, _jquery2.default)("#scroll-down").fadeOut("slow");
            (0, _jquery2.default)("#scroll-up").fadeIn("slow");
          }
          if ((0, _jquery2.default)(this).closest('#scroll-up').length == 1) {
            (0, _jquery2.default)("#scroll-up").fadeOut("slow");
            (0, _jquery2.default)("#scroll-down").fadeIn("slow");
          }
          return false;
        }
      }
...
(0, _jquery2.default)(function () {
  if ((0, _jquery2.default)('body').hasClass('team-page')) {

    (0, _jquery2.default)('.member').on("click", ".setting", function () {
      var name = (0, _jquery2.default)(this).data("name"),
          type = (0, _jquery2.default)(this).data("type"),
          currentType = (0, _jquery2.default)(this).closest('.row').data('current-type');

      (0, _jquery2.default)('#' + name + ' .' + currentType).fadeOut('slow', function () {
        (0, _jquery2.default)('#' + name + ' .' + type).removeClass('hide').fadeIn('slow');
      });
    });
  }
});
